...
- [x] **引擎大扩张**（0.3.x）：每个翻译引擎都有「测试连接」按钮、加入有道云 OCR + 有道图翻、Google 翻译、腾讯智能体段落合并、漫画里的小注音不再重复翻、长译文跑马灯滚动
- [x] **从整屏到单词**（0.3.4+）：划词翻译卡片（音标 / 词性 / 释义 / 例句）、主球单击行为可切换（整屏翻 ↔ 划词翻）、弧菜单按钮顺序可自定义、其它 App 长按选词进入屏译翻译
