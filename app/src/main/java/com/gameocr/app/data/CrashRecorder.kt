...
object CrashRecorder {
    ...
    fun formatSettings(s: Settings): String = buildString {
        ...
        line("loopTriggerMode", s.loopTriggerMode)
        line("loopTextStableDurationMs", s.loopTextStableDurationMs)
        line("loopSkipSimilarFrames", s.loopSkipSimilarFrames)
        line("loopFrameSimilarityThreshold", s.loopFrameSimilarityThreshold)
        line("loopTextRegionMode", s.loopTextRegionMode)
        line("loopTranslateRegionOnly", s.loopTranslateRegionOnly)
        line("developerOptionsEnabled", s.developerOptionsEnabled)
        line("ocrRedBoxModeEnabled", s.ocrRedBoxModeEnabled)
        line("ocrRedBoxShowSourceText", s.ocrRedBoxShowSourceText)
        line("ocrRedBoxShowTranslation", s.ocrRedBoxShowTranslation)
        ...
        line("retryEmptyTranslation", s.retryEmptyTranslation)
        line("renderMode", s.renderMode)
        line("translationBlockInteractionMode", s.translationBlockInteractionMode)
        ...
        line("translationGlossaryEnabled", s.translationGlossaryEnabled)
        line("foregroundAppDetectionMode", s.foregroundAppDetectionMode)
        line("sendAppNameToTranslator", s.sendAppNameToTranslator)
        line("runtimeTranslationContext", brief(s.runtimeTranslationContext))
